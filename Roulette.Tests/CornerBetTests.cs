...
namespace Roulette.Tests
{
    public class CornerBetTests
    {
        ...
        [Fact]
        public void CalculateBet_Should_ReturnFalse()
        {
            var bet = new List<int> { 1, 2, 4, 5 };
        ...
        public void CalculateBet_With_Data_Should_ReturnTrue(List<int> bet, int wheelNumber)
        {
        ...
        public void CalculateBet_With_Data_Should_ReturnFalse(List<int> bet, int wheelNumber)
        {
